$(function() {
    ...
    var setNight = function () {
        ...
        jQuery.ajax({
            url: 'https://0bkltamdoa.execute-api.eu-central-1.amazonaws.com/prod/metno/sunrise/1.1?lat=' + lat + '&lon=' + lon + '&date=' + img.data('date').substring(0, 10),
            dataType: 'xml',
    ...
    $.ajax({
        type: 'GET',
        url: 'https://0bkltamdoa.execute-api.eu-central-1.amazonaws.com/prod/metno/locationforecast/1.9?lat=' + lat + '&lon=' + lon,
        dataType: 'xml',
        success: function (xml) {
